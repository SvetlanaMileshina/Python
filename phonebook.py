...
def copy_contact():# функция для копирования
    with open("phonebook.txt",'r',encoding='utf-8') as file: 
        contacts_str = file.read()
        contacts_list = contacts_str.rstrip().split('\n\n')
    for n,contact in enumerate(contacts_list, 1): # нумеруем список контактов начиная с 1,а не с 0.В n-номер контакта, в contact-сам контакт текущий, перебираем
        print(n,contact) # выводим на экран
    print()
